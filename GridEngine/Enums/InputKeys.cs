...
namespace GridEngine.Enums
{
    public static class InputKeys
    {
        public static Keys FromValue(int value)
        {
            return (Keys)value;
        }

        /// <summary>
        /// A copy of the "VirtualKey" enum from the namespace "Windows.System" as of 21/07/2018.
        /// To allow compatibility with UWP.
        /// </summary>
        public enum Keys
        {
            //
